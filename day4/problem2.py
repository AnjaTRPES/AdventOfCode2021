...
def playBingo(randomNumbers, boards):
    ...
    while len(boards) > 0:
        ...
        # draw a number!
        posRandom += 1
        print('first round!', posRandom, randomNumbers[posRandom])
...
finalNumber, finalBoard = playBingo(randomNumbers, boards)
print('final score: ', getWinningScore(finalNumber, finalBoard))
