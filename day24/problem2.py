...
for test in [31111121382151]:# not valid, it said it is too high??
    test = str(test)
    if '0' not in test: 
...
# In equations, smallest number::
inp0 = inp13 + 2 # inp0= 3, inp13 = 1
inp1 = inp12 - 4 # inp12= 1, inp1 = 5
inp2 = inp9 - 7  # inp9=8, inp2=1
inp3 = inp4 # both must be 1
inp5 = inp6 - 1 # inp6=2, inp5=1
inp7 = inp8 - 2 # inp8=3, inp7=1
inp10 = inp11+1 # inp10=2, inp11 = 1
#MN: 3111121382151
'''
inp0 = 3
inp13 = 1
...
mn = []
for m in [inp0, inp1, inp2, inp3,inp4,inp5,inp6, inp7, inp8,
          inp9, inp10, inp11, inp12, inp13]:
    mn.append(str(m))
print(''.join(mn))
